...
export default function Header() {
  ...
  const handleSunmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault()
  ...
  return (
    <header className={isHome ? 'bg-header bg-center bg-cover' : 'bg-slate-800'}>
      <div className='mx-auto container px-5 py-16'>
        ...
        {isHome && (
          <form className="md:w-1/2 2xl:w-1/3 bg-orange-400 my-32 p-10 rounded-lg shadow space-y-6" onSubmit={handleSunmit}>
            <div className="space-y-4">
             ...
             <div className="space-y-4">
               <label htmlFor="category" className="block text-white uppercase font-extrabold text-lg">Categorias</label>
               <select id="category"
                       name="category"
